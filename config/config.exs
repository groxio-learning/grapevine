...
config :grapevine, Grapevine.Mailer, adapter: Swoosh.Adapters.Local
...
config :grapevine, :components, [
  {Grapevine.Components.Form.ErrorTag,
   default_translator: {GrapevineWeb.ErrorHelpers, :translate_error}}
]
