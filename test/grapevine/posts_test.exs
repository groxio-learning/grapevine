defmodule Grapevine.PostsTest do
  ...
  test "get all posts" do
      %{id: id} = user_fixture()
      {:ok, post_one} =  Posts.create(%{"title" => "my first post",  "content" => "https://google.com", "user_id" => id }, id)
      {:ok, post_two} =  Posts.create(%{"title" => "the second one", "content" => "https://wikipedia.org", "user_id" => id}, id)
